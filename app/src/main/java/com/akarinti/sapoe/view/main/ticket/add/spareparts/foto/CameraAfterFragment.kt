...
class CameraAfterFragment : BaseMvpFragment<CameraAfterPresenter>(), CameraAfterContract.View {
    override fun gotoNextPage() {

    }
    @Inject
    override lateinit var presenter: CameraAfterPresenter
                ...
                CodeIntent.UPLOAD_IMAGE -> {
                    ...
                    if (success) {
                        ...
                        if(imageFile!=null) {
                            ...
                            listener?.let {
                                it.getCameraAfter("data:image/png;base64,"+
    ...
    interface Listener{
        fun getCameraAfter(imagefile:String)
    }
}