package com.akarinti.sapoe.view.main.unscheduled.answer_parent.question
...
class UAnswerActivity : BaseActivity() {
    ...
    companion object {
        fun newInstance(activity: Activity, parent: ParentAcOffline?, scheduleType: String?, selectedFormIndex: Int?, selectedChildIndex: Int? = -1) {
            activity.startActivity(activity.intentFor<UAnswerActivity>(
        ...
        fun newInstance(activity: Activity, parent: ParentOtherOffline?, scheduleType: String?, selectedFormIndex: Int?, selectedChildIndex: Int? = -1) {
            activity.startActivity(activity.intentFor<UAnswerActivity>(
